...
class Main extends Component {
  ...
  handleDelete = (id) => {
    this.setState({
      contents: this.state.contents.filter(el =>
        el.id !== id)
    })
  }
  ...
  handleLikeHeart =() =>{
    this.setState({
      ...
      like:this.state.heart? this.state.like -1 : this.state.like +1
      ...
      <div className='maincomponent'>
        <header className="section">
          <div className="inner">
            ...
            <nav>
              <svg aria-label="홈" className="_8-yf5 " fill="#262626" height="22" viewBox="0 0 48 48" width="22">
                <path
              ...
              <svg aria-label="사람 찾기" className="_8-yf5 " fill="#262626" height="22" viewBox="0 0 48 48" width="22">
                <path clip-rule="evenodd"
                  d="M24 0C10.8 0 0 10.8 0 24s10.8 24 24 24 24-10.8 24-24S37.2 0 24 0zm0 45C12.4 45 3 35.6 3 24S12.4 3 24 3s21 9.4 21 21-9.4 21-21 21zm10.2-33.2l-14.8 7c-.3.1-.6.4-.7.7l-7 14.8c-.3.6-.2 1.3.3 1.7.3.3.7.4 1.1.4.2 0 .4 0 .6-.1l14.8-7c.3-.1.6-.4.7-.7l7-14.8c.3-.6.2-1.3-.3-1.7-.4-.5-1.1-.6-1.7-.3zm-7.4 15l-5.5-5.5 10.5-5-5 10.5z"
                  fill-rule="evenodd"></path>
              </svg>
              <svg aria-label="활동 피드" className="_8-yf5 " fill="#262626" height="22" viewBox="0 0 48 48" width="22">
                <path
                  d="M34.6 6.1c5.7 0 10.4 5.2 10.4 11.5 0 6.8-5.9 11-11.5 16S25 41.3 24 41.9c-1.1-.7-4.7-4-9.5-8.3-5.7-5-11.5-9.2-11.5-16C3 11.3 7.7 6.1 13.4 6.1c4.2 0 6.5 2 8.1 4.3 1.9 2.6 2.2 3.9 2.5 3.9.3 0 .6-1.3 2.5-3.9 1.6-2.3 3.9-4.3 8.1-4.3m0-3c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5.6 0 1.1-.2 1.6-.5 1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z">
                </path>
              </svg>
              <div className="img--container">
                <img width="30px" alt="oooosalon님의 프로필 사진" className="_6q-tv" crossorigin="anonymous"
            ...
            <section className="contents__all">
                ...
                <div className="up__inner">
                  ...
                  <div className="up__list">
                    <div className="up__img">
                      <img salt="seol.zzi님의 프로필 사진" className="_6q-tv" data-testid="user-avatar" draggable="false"
                  ...
                  <div className="up__list">
                    <div className="up__img">
                      <img salt="muchable.nl님의 프로필 사진" className="_6q-tv" data-testid="user-avatar"
                        draggable="false"
                  ...
                  <div className="up__list">
                    <div className="up__img">
                      <img salt="coucou_illustration님의 프로필 사진" className="_6q-tv" data-testid="user-avatar"
                        draggable="false"
                  ...
                  <div className="up__list">
                    <div className="up__img">
                      <img salt="moyeon__flower님의 프로필 사진" className="_6q-tv" data-testid="user-avatar"
                        draggable="false"
              ...
              <div className="contents__down">
                <div className="title">
                  ...
                  <div className="list__inner">
                    <div className="img--container">
                      <img width="100%" alt="oooosalon님의 프로필 사진" className="_6q-tv" crossorigin="anonymous"
                        data-testid="user-avatar" draggable="false"
                  ...
                  <div className="picture">
                    <img src="https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-15/e35/153598097_116741346993457_249445519375038439_n.jpg?_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_cat=101&_nc_ohc=3chLwg_1RUYAX8dJ7op&tp=1&oh=e96b52c4eac9a04b497e730b9973f6b0&oe=605FD690"
                      alt="insta1" />
                  </div>
                  <div className="symbol">
                    <i 
                    onClick={this.handleLikeHeart}
                    style={{color: this.state.heart?'tomato':'black',fontSize: 24 }}
                    className="far fa-heart" ></i>
                    <i className="far fa-comments" style={{ fontSize: 24 }}></i>
                    <i className="fab fa-telegram-plane" style={{ fontSize: 24 }}></i>
                  </div>
                  <div className="like">좋아요 <span>{this.state.like}</span>개</div>
                  <div className="reply--list">
                    ...
                    <div className="reply">
                      ...
                      <div className="reply__heart"><i className="far fa-heart"></i></div>
                    </div>
                    <Reply contents={this.state.contents}
                  ...
                  <div className="write">
                    <form
                      ...
                      <input
                        ...
                        className="mainInput" name="reply" type="text" placeholder="댓글 달아요" />
                      <button 
                      style={{color: this.state.text.length? '#199FF6':'#B2DFFC' }}
                      type="submit" className="write__send"   >게시</button>
              ...
              <aside>
                ...
                <div className="aside_up">
                  ...
                  <div className="transform"><a href="" className="btn--blue">전환</a> </div>
                </div>
                <div className="aside_down">
                  ...
                  <div className="list">
                    <div className="list__inner">
                      ...
                      <div className="follow"><a href="" className="btn--blue">팔로우</a> </div>
                    </div>
