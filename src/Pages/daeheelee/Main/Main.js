                    ...
                    <article>
											...
											<div className='iconline'>
												<div className='iconBox'>
													<a className='heartIcon'><i className="far fa-heart fa-2x" /> </a>                     
											...
											<div className='text'>
												<span className='name'>wecode_bootcamp</span><span className='info'>일 잘하는 직장인을 위한 👩🏻‍🔬👨🏻‍✈️👩🏻‍🏫👮🏻‍♀️👨🏻‍💼
												wecode social club 2기가 시작되었습니다. </span>
											</div>
                    </article>
                    <ul className='comments'>
                    	<li className='comment'>
												<span className='name'>Wecodebootcamp</span><span className='cominfo'>최고의 공간 WeWork에서 진행되는 세션</span>
											</li>
                    </ul>
